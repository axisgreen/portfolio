					...
					<div className="p-4 rounded-md">
						<JobTile
							...
							details={
								<>
									<li>
										Developing on both new and existing project codebases using
										the MERN (MongoDB, Express, React, Node.js) stack
									</li>
									<li>
										Mobile app development targeting both iOS and Android using
										Flutter
									</li>
									<li>
										Deploying machine learning models using Docker onto Windows
										and Linux stacks
									</li>
									<li>
									...
									<li>
										Liaising with project stakeholders on the project milestones
										and deliverables
									</li>
								</>
							}
						...
						<JobTile
							...
							details={
								<>
									...
									<li>
										Provide general help with student queries and redirecting to
										proper resources or services
									</li>
									<li>
										Allocating students to mentors and handling students, during
										busy hours
									</li>
